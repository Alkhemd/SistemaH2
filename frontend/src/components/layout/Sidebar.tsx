          ...
          {navigation.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                href={item.href}
                className={`group relative p-6 rounded-xl text-center transition-all duration-200 ${isActive
          ...
          {catalogos.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                href={item.href}
                className={`group relative p-4 rounded-xl transition-all duration-200 flex items-center space-x-3 ${isActive
