    ...
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Gestión Médica Integral</p>
        </div>

        {/* Opciones principales - Grid centrado */}
          ...
          {navigation.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={`
                  group relative p-6 rounded-xl text-center transition-all duration-200
                  ${isActive 
        ...
        <div className="text-center mb-4">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Catálogos</h2>
        </div>
          ...
          {catalogos.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={`
                  group relative p-4 rounded-xl transition-all duration-200 flex items-center space-x-3
                  ${isActive 
