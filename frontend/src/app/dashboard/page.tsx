...
const ActivityTimeline = dynamic(() => import('@/components/dashboard/ActivityTimeline'), { ssr: false });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-slide-up" style={{ animationDelay: '0.2s' }}>
        ...
        {/* Row 1: Distribution & Technician Workload */}
        {chartData && (
        ...
        {/* Row 2: Orders Priority Chart (Full Width) */}
        {chartData && (
